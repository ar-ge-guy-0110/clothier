...
JOIN cloth_which_bodytype_category ON cloth.id = cloth_which_bodytype_category.cloth_id JOIN body_type ON cloth_which_bodytype.body_type_id = body_type.id 
