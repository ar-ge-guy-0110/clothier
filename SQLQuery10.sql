...
WHERE cloth_bmi_category.bmi_name = 'Normal' 
AND body_type.body_type_name = 'Cone' 
AND cloth_clothingstyle_category.category_name = 'Vintage' 
AND cloth_season_category.category_name = 'Summer Season' 
AND cloth_place_category.category_name = 'Holiday'