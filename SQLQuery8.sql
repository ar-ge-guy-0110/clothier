SELECT user_outfit_combination.id, user_outfit_combination.dress_slot, cloth_image.image, 
...
user_outfit_combination.bag_slot, cloth_image5.image, 
user_outfit_combination.combination_name FROM user_outfit_combination 
...
LEFT JOIN cloth_image AS cloth_image5 ON user_outfit_combination.bag_slot = cloth_image5.cloth_id WHERE user_outfit_combination.user_id = 1 OR user_outfit_combination.sharing = 1